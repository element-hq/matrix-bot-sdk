...
describe("MatrixClient", () => {
  describe("constructor", () => {
    ...
    it("should create a crypto client when requested", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const homeserverUrl = "https://example.org";
        const accessToken = "example_token";
        ...
        const client = new MatrixClient(
          ...
          accessToken,
          null,
          new RustSdkCryptoStorageProvider(tmp.dirSync().name, cryptoStoreType),
        );
  ...
  describe("doRequest", () => {
    ...
    it("should send the appropriate body", async () => {
      ...
      await Promise.all([
        client.doRequest("PUT", "/test", null, expectedInput),
        http.flushAllExpected(),
      ]);
    });
    ...
    it("should send application/json by default", async () => {
      ...
      await Promise.all([
        client.doRequest("PUT", "/test", null, { test: 1 }),
        http.flushAllExpected(),
      ]);
    });
    ...
    it("should proxy the timeout to request", async () => {
      ...
      await Promise.all([
        client.doRequest("GET", "/test", null, null, timeout),
        http.flushAllExpected(),
      ]);
    });
  });
  ...
  describe("impersonateUserId", () => {
    it("should set a user_id param on requests", async () => {
      ...
      http.when("GET", "/test").respond(200, (path, content, req) => {
        ...
        expect(req.queryParams["device_id"]).toBe(undefined);
      });
    ...
    it("should set a device_id param on requests", async () => {
      ...
      http.when("GET", "/test").respond(200, (path, content, req) => {
        expect(req.queryParams["user_id"]).toBe(userId);
        expect(req.queryParams["device_id"]).toBe(deviceId);
      });
  ...
  describe("getServerVersions", () => {
    it("should call the right endpoint", async () => {
      const { client, http } = createTestClient(undefined, undefined, undefined, {
        handleWhoAmI: true,
        precacheVersions: false,
      });
  ...
  describe("doesServerSupportUnstableFeature", () => {
    test.each(<[ServerVersions["unstable_features"], string, boolean][]>[
      ...
      const [result] = await Promise.all([
        client.doesServerSupportUnstableFeature(flag),
        http.flushAllExpected(),
      ]);
  ...
  describe("doesServerSupportVersion", () => {
    test.each(<[ServerVersions["versions"], string, boolean][]>[
      ...
      const [result] = await Promise.all([
        client.doesServerSupportVersion(version),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(target);
    });
  ...
  describe("doesServerSupportAnyOneVersion", () => {
    test.each(<[ServerVersions["versions"], string[], boolean][]>[
      ...
      const [result] = await Promise.all([
        client.doesServerSupportAnyOneVersion(searchVersions),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(target);
    });
  ...
  describe("getOpenIDConnectToken", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("POST", "/_matrix/client/v3/user").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/user/${encodeURIComponent(userId)}/openid/request_token`,
        );
        return testToken;
      });
  ...
  describe("getIdentityServerClient", () => {
    ...
    it("should prepare an identity server client", async () => {
      ...
      const [iClient] = await Promise.all([
        client.getIdentityServerClient(identityDomain),
        http.flushAllExpected(),
      ]);
  ...
  describe("getAccountData", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/user").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/user/${encodeURIComponent(userId)}/account_data/${encodeURIComponent(eventType)}`,
        );
        return {};
      });
  ...
  describe("getSafeAccountData", () => {
    ...
    it("should return the default on error", async () => {
      ...
      const [ret] = await Promise.all([
        client.getSafeAccountData(eventType, defaultContent),
        http.flushAllExpected(),
      ]);
  ...
  describe("getPresenceStatus", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/presence").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/presence/${encodeURIComponent(userId)}/status`,
        );
        return presenceObj;
      });
  ...
  describe("getPresenceStatusFor", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getPresenceStatusFor(userId),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined(); // The shape of the object is handled by other tests
    });
  ...
  describe("getRoomAccountData", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/user").respond(200, (path) => {
        ...
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/user/${encodeURIComponent(userId)}/rooms/${encodeURIComponent(roomId)}/account_data/${encodeURIComponent(eventType)}`,
        );
        return {};
      });
  ...
  describe("getSafeRoomAccountData", () => {
    it("should call the right endpoint", async () => {
      ...
      await Promise.all([
        client.getSafeRoomAccountData(eventType, roomId),
        http.flushAllExpected(),
      ]);
    });
    ...
    it("should return the default on error", async () => {
      ...
      const [ret] = await Promise.all([
        client.getSafeRoomAccountData(eventType, roomId, defaultContent),
        http.flushAllExpected(),
      ]);
      expect(ret).toBe(defaultContent);
    });
  ...
  describe("setRoomAccountData", () => {
    it("should call the right endpoint", async () => {
      ...
      await Promise.all([
        client.setRoomAccountData(eventType, roomId, eventContent),
        http.flushAllExpected(),
      ]);
    });
  });
  ...
  describe("getPublishedAlias", () => {
    it("should return falsey on 404", async () => {
      ...
      const [published] = await Promise.all([
        client.getPublishedAlias(roomId),
        http.flushAllExpected(),
      ]);
  ...
  describe("createRoomAlias", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/directory/room/").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/directory/room/${encodeURIComponent(alias)}`,
        );
  ...
  describe("setDirectoryVisibility", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/directory/list/room/").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/directory/list/room/${encodeURIComponent(roomId)}`,
        );
      ...
      await Promise.all([
        client.setDirectoryVisibility(roomId, visibility),
        http.flushAllExpected(),
      ]);
    });
  });
  ...
  describe("getDirectoryVisibility", () => {
    ...
    it("should return the right visibility string", async () => {
      ...
      // noinspection TypeScriptValidateJSTypes
      http
        .when("GET", "/_matrix/client/v3/directory/list/room/")
        .respond(200, { visibility: visibility });

      const [result] = await Promise.all([
        client.getDirectoryVisibility(roomId),
        http.flushAllExpected(),
      ]);
  ...
  describe("resolveRoom", () => {
    ...
    it("should try to look up room aliases", async () => {
      ...
      const spy = simple.stub().returnWith(
        new Promise<RoomDirectoryLookupResponse>((resolve) =>
          resolve({
            roomId: roomId,
            residentServers: [],
          }),
  ...
  describe("lookupRoomAlias", () => {
    ...
    it("should return a translated response", async () => {
      ...
      // noinspection TypeScriptValidateJSTypes
      http
        .when("GET", "/_matrix/client/v3/directory/room/")
        .respond(200, { room_id: roomId, servers: servers });
  ...
  describe("inviteUser", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("POST", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/invite`,
        );
  ...
  describe("unbanUser", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("POST", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/unban`,
        );
        expect(content).toMatchObject({ user_id: userId });
        return {};
      });
  ...
  describe("start", () => {
    ...
    it("should create a filter when the stored filter is outdated", async () => {
      ...
      simple
        .mock(storage, "getFilter")
        .returnWith({ id: filterId + "__WRONG", filter: { wrong_filter: 1 } });
      ...
      http.when("POST", "/_matrix/client/v3/user").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/user/${encodeURIComponent(userId)}/filter`,
        );
  ...
  describe("processSync", () => {
    ...
    it("should process crypto if enabled", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const { client: realClient } = createTestClient(
          null,
          "@alice:example.org",
  ...
  describe("getEvent", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/event/${encodeURIComponent(eventId)}`,
        );
        return event;
      });

      const [result] = await Promise.all([
        client.getEvent(roomId, eventId),
        http.flushAllExpected(),
      ]);
    ...
    it("should not try decryption in unencrypted rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const { client, http, hsUrl } = createTestClient(
          null,
          "@alice:example.org",
  ...
  describe("getRawEvent", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getRawEvent(roomId, eventId),
        http.flushAllExpected(),
      ]);
      expect(result).toMatchObject(event);
    });
    ...
    it("should not try decryption in any rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const { client, http, hsUrl } = createTestClient(
          null,
          "@alice:example.org",
  ...
  describe("getRoomState", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/state`,
        );
        return events;
      });
  ...
  describe("getRoomStateEventContent", () => {
    ...
    it("should call the right endpoint with an empty state key", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/state/${encodeURIComponent(eventType)}/`,
        );
        return event;
      });

      const [result] = await Promise.all([
        client.getRoomStateEventContent(roomId, eventType, ""),
        http.flushAllExpected(),
      ]);
      expect(result).toMatchObject(event);
    });
    ...
    it("should call the right endpoint with a state key", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/state/${encodeURIComponent(eventType)}/${stateKey}`,
        );
        return event;
      });

      const [result] = await Promise.all([
        client.getRoomStateEventContent(roomId, eventType, stateKey),
        http.flushAllExpected(),
      ]);
      expect(result).toMatchObject(event);
    });
  ...
  describe("getRoomStateEventBody", () => {
    ...
    it("should call the right endpoint with an empty state key", async () => {
      const { client, http, hsUrl } = createTestClient(undefined, undefined, undefined, {
        precacheVersions: false,
      });
      http
        .when("GET", "/_matrix/client/versions")
        .respond(200, { versions: ["v1.16"] } satisfies ServerVersions);
      // noinspection TypeScriptValidateJSTypes
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/state/${encodeURIComponent(eventType)}/`,
      ...
      const [result] = await Promise.all([
        client.getRoomStateEventBody(roomId, eventType, ""),
        http.flushAllExpected(),
      ]);
      expect(result).toMatchObject(event);
    });
    ...
    it("should call the right endpoint with a state key", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomStateEventBody(roomId, eventType, stateKey),
        http.flushAllExpected(),
      ]);
      expect(result).toMatchObject(event);
    });
    ...
    it("should call the fallback endpoint with a state key", async () => {
      ...
      http
        .when("GET", "/_matrix/client/versions")
        .respond(200, { versions: [] } satisfies ServerVersions);

      // noinspection TypeScriptValidateJSTypes
      http
        .when("GET", `/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/state`)
        .respond(200, () => {
          return [event];
        });
  ...
  describe("getEventContext", () => {
    it("should use the right endpoint", async () => {
      ...
      const before = [
        { type: "m.room.message", content: { body: "1", msgtype: "m.text" } },
        {
          type: "m.room.message",
      ...
      const after = [
        { type: "m.room.message", content: { body: "3", msgtype: "m.text" } },
        {
          type: "m.room.message",
      ...
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path, content, req) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/context/${encodeURIComponent(targetEvent.eventId)}`,
        );
      ...
      const [result] = await Promise.all([
        client.getEventContext(roomId, targetEvent.eventId, limit),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
  ...
  describe("getEventNearestToTimestamp", () => {
    it("should use the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v1/rooms").respond(200, (path, _content, req) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v1/rooms/${encodeURIComponent(roomId)}/timestamp_to_event`,
        );
      ...
      const [result] = await Promise.all([
        client.getEventNearestToTimestamp(roomId, timestamp, dir),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
  ...
  describe("setDisplayName", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/profile").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/profile/${encodeURIComponent(userId)}/displayname`,
        );
  ...
  describe("setAvatarUrl", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/profile").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/profile/${encodeURIComponent(userId)}/avatar_url`,
        );
  ...
  describe("joinRoom", () => {
    ...
    it("should call the right endpoint with server names", async () => {
      ...
      const [result] = await Promise.all([
        client.joinRoom(roomId, serverNames),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(roomId);
    });
  ...
  describe("getJoinedRoomMembersWithProfiles", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getJoinedRoomMembersWithProfiles(roomId),
        http.flushAllExpected(),
      ]);
  ...
  describe("getRoomMembers", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("GET", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/members`,
        );
    ...
    it("should call the right endpoint with a batch token", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomMembers(roomId, atToken),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(2);
    ...
    it("should call the right endpoint with membership filtering", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomMembers(roomId, null, forMemberships, forNotMemberships),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(2);
  ...
  describe("getRoomMembersByMembership", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomMembersByMembership(roomId, "join"),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
    ...
    it("should call the right endpoint with a batch token", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomMembersByMembership(roomId, "join", batchToken),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(1);
  ...
  describe("getRoomMembersWithoutMembership", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomMembersWithoutMembership(roomId, "join"),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(1);
    ...
    it("should call the right endpoint with a batch token", async () => {
      ...
      const [result] = await Promise.all([
        client.getRoomMembersWithoutMembership(roomId, "join", batchToken),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(1);
  ...
  describe("getAllRoomMembers", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getAllRoomMembers(roomId),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(2);
    ...
    it("should call the right endpoint with a batch token", async () => {
      ...
      const [result] = await Promise.all([
        client.getAllRoomMembers(roomId, batchToken),
        http.flushAllExpected(),
      ]);
      expect(result).toBeDefined();
      expect(result.length).toBe(2);
  ...
  describe("leaveRoom", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("POST", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        expect(content).toEqual({});
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/leave`,
        );
        return {};
      });
  ...
  describe("forgetRoom", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("POST", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/forget`,
        );
        return {};
      });
  ...
  describe("sendReadReceipt", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("POST", "/_matrix/client/v3/rooms").respond(200, (path) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/receipt/m.read/${encodeURIComponent(eventId)}`,
        );
        return {};
      });
  ...
  describe("setTyping", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        expect(path).toEqual(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/typing/${encodeURIComponent(userId)}`,
        );
  ...
  describe("replyText", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        const idx = path.indexOf(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/send/m.room.message/`,
        );
        expect(idx).toBe(0);
      ...
      const [result] = await Promise.all([
        client.replyText(roomId, originalEvent, replyText, replyHtml),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });

    it("should try to encrypt in encrypted rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const { client, http, hsUrl } = createTestClient(
          null,
          "@alice:example.org",
        ...
        http.when("PUT", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
          const idx = path.indexOf(
            `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/send/m.room.encrypted/`,
          );
          expect(idx).toBe(0);
          expect(content).toMatchObject(expectedContent);
          return { event_id: eventId };
    ...
    it("should not try to encrypt in unencrypted rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const { client, http, hsUrl } = createTestClient(
          null,
          "@alice:example.org",
    ...
    it("should omit HTML when replying with plain text", async () => {
      ...
      const [result] = await Promise.all([
        client.replyText(roomId, originalEvent, replyText),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("replyHtmlText", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.replyHtmlText(roomId, originalEvent, replyHtml),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("replyNotice", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.replyNotice(roomId, originalEvent, replyText, replyHtml),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
    ...
    it("should omit HTML when replying with plain text", async () => {
      ...
      const [result] = await Promise.all([
        client.replyNotice(roomId, originalEvent, replyText),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("replyHtmlNotice", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.replyHtmlNotice(roomId, originalEvent, replyHtml),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("sendNotice", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.sendNotice(roomId, eventContent.body),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("sendHtmlNotice", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.sendHtmlNotice(roomId, eventContent.formatted_body),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("sendText", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.sendText(roomId, eventContent.body),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("sendHtmlText", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.sendHtmlText(roomId, eventContent.formatted_body),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("sendMessage", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.sendMessage(roomId, eventContent),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
    ...
    it("should try to encrypt in encrypted rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        ...
        const [result] = await Promise.all([
          client.sendMessage(roomId, eventPlainContent),
          http.flushAllExpected(),
        ]);
        expect(result).toEqual(eventId);
      }));
  ...
  describe("sendEvent", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        const idx = path.indexOf(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/send/${encodeURIComponent(eventType)}/`,
        );
        expect(idx).toBe(0);
        expect(content).toMatchObject(eventContent);
        return { event_id: eventId };
      ...
      const [result] = await Promise.all([
        client.sendEvent(roomId, eventType, eventContent),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
    ...
    it("should try to encrypt in encrypted rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        ...
        http.when("PUT", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
          const idx = path.indexOf(
            `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/send/${encodeURIComponent(sEventType)}/`,
          );
          expect(idx).toBe(0);
          expect(content).toMatchObject(eventContent);
          return { event_id: eventId };
        ...
        const [result] = await Promise.all([
          client.sendEvent(roomId, eventType, eventPlainContent),
          http.flushAllExpected(),
        ]);
        expect(result).toEqual(eventId);
      }));
  ...
  describe("sendRawEvent", () => {
    ...
    it("should not try to encrypt in any rooms", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const { client, http, hsUrl } = createTestClient(
          null,
          "@alice:example.org",
        ...
        const [result] = await Promise.all([
          client.sendRawEvent(roomId, eventType, eventContent),
          http.flushAllExpected(),
        ]);
        expect(result).toEqual(eventId);
      }));
  ...
  describe("sendStateEvent", () => {
    it("should call the right endpoint with no state key", async () => {
      ...
      const [result] = await Promise.all([
        client.sendStateEvent(roomId, eventType, stateKey, eventContent),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(eventId);
    });
  ...
  describe("redactEvent", () => {
    it("should call the right endpoint", async () => {
      ...
      http.when("PUT", "/_matrix/client/v3/rooms").respond(200, (path, content) => {
        const idx = path.indexOf(
          `${hsUrl}/_matrix/client/v3/rooms/${encodeURIComponent(roomId)}/redact/${encodeURIComponent(eventId)}/`,
        );
        expect(idx).toBe(0);
  ...
  describe("setUserPowerLevel", () => {
    it("should use the current power levels as a base", async () => {
      ...
      const getStateEventSpy = simple
        .mock(client, "getRoomStateEventContent")
        .callFn((rid, evType, stateKey) => {
          expect(rid).toEqual(roomId);
      ...
      const sendStateEventSpy = simple
        .mock(client, "sendStateEvent")
        .callFn((rid, evType, stateKey, content) => {
          expect(rid).toEqual(roomId);
          expect(evType).toEqual("m.room.power_levels");
          expect(stateKey).toEqual("");
          expect(content).toMatchObject(
            Object.assign({}, { users: { [userId]: targetLevel } }, basePowerLevels),
          );
          return null;
        });
  ...
  describe("mxcToHttp", () => {
    it("should convert to the right URL", async () => {
      ...
      expect(http).toBe(
        `${hsUrl}/_matrix/client/v1/media/download/${encodeURIComponent(domain)}/${encodeURIComponent(mediaId)}`,
      );
    });
  ...
  describe("mxcToHttpThumbnail", () => {
    it("should convert to the right URL", async () => {
      ...
      // eslint-disable-next-line max-len
      expect(http).toBe(
        `${hsUrl}/_matrix/client/v1/media/thumbnail/${encodeURIComponent(domain)}/${encodeURIComponent(mediaId)}?width=${width}&height=${height}&method=${encodeURIComponent(method)}`,
      );
    });
  ...
  describe("uploadContent", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.uploadContent(data, contentType, filename),
        http.flushAllExpected(),
      ]);
  ...
  describe("uploadContentFromUrl", () => {
    it("should download then upload the content", async () => {
      ...
      const [result] = await Promise.all([
        client.uploadContentFromUrl(`${hsUrl}/sample/download`),
        http.flushAllExpected(),
      ]);
      expect(result).toEqual(uri);
    });
  ...
  describe("upgradeRoom", () => {
    it("should call the right endpoint", () =>
      testCryptoStores(async (cryptoStoreType) => {
        ...
        http
          .when("POST", `/_matrix/client/v3/rooms/${encodeURIComponent(oldRoomId)}/upgrade`)
        ...
        const [result] = await Promise.all([
          client.upgradeRoom(oldRoomId, newRoomVersion),
          http.flushAllExpected(),
        ]);
  ...
  describe("getRoomUpgradeHistory", () => {
    ...
    it("should handle cases with no known newer rooms", async () => {
      ...
      const expected = {
        ...
        current: { roomId: "!current:localhost", version: "3", refEventId: null },
        newer: [{ roomId: "!new-v1:localhost", version: "1", refEventId: null }],
      };
  ...
  describe("uploadDeviceOneTimeKeys", () => {
    ...
    it("should call the right endpoint", () =>
      testCryptoStores(async (cryptoStoreType) => {
        ...
        const [result] = await Promise.all([
          client.uploadDeviceOneTimeKeys(keys),
          http.flushAllExpected(),
        ]);
  ...
  describe("getUserDevices", () => {
    it("should call the right endpoint", async () => {
      ...
      const [result] = await Promise.all([
        client.getUserDevices(Object.keys(requestBody), timeout),
        http.flushAllExpected(),
      ]);
      expect(result).toMatchObject(response);
    });

    it("should call the right endpoint with a default timeout", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const userId = "@test:example.org";
        const { client, http } = createTestClient(null, userId, cryptoStoreType);
        ...
        const [result] = await Promise.all([
          client.getUserDevices(Object.keys(requestBody)),
          http.flushAllExpected(),
        ]);
        expect(result).toMatchObject(response);
      }));
  ...
  describe("claimOneTimeKeys", () => {
    ...
    it("should call the right endpoint", () =>
      testCryptoStores(async (cryptoStoreType) => {
        ...
        const [result] = await Promise.all([
          client.claimOneTimeKeys(request),
          http.flushAllExpected(),
        ]);
        expect(result).toMatchObject(response);
      }));

    it("should use the timeout parameter", () =>
      testCryptoStores(async (cryptoStoreType) => {
        const userId = "@test:example.org";
        const { client, http } = createTestClient(null, userId, cryptoStoreType);
        ...
        const [result] = await Promise.all([
          client.claimOneTimeKeys(request, timeout),
          http.flushAllExpected(),
        ]);
        expect(result).toMatchObject(response);
      }));
    ...
    it("should call the right endpoint", () =>
      testCryptoStores(async (cryptoStoreType) => {
        ...
        http.when("PUT", "/_matrix/client/v3/sendToDevice").respond(200, (path, content) => {
          const idx = path.indexOf(
            `${hsUrl}/_matrix/client/v3/sendToDevice/${encodeURIComponent(type)}/`,
          );
          expect(idx).toBe(0);
  ...
  describe("getRelationsForEvent", () => {
    test.each([
      ...
      const eventId = "$event";
      const response = {
        chunk: [{ eventContents: true }, { eventContents: true }, { eventContents: true }],
      };
      ...
      http.when("GET", "/_matrix/client/v1/rooms").respond(200, (path, content) => {
        ...
        // eslint-disable-next-line max-len
        const idx = path.indexOf(
          `${hsUrl}/_matrix/client/v1/rooms/${encodeURIComponent(roomId)}/relations/${encodeURIComponent(eventId)}${relTypeComponent}${eventTypeComponent}`,
        );
        expect(idx).toBe(0);
        return response;
      });
      ...
      const [result] = await Promise.all([
        client.getRelationsForEvent(roomId, eventId, relType, eventType),
        http.flushAllExpected(),
      ]);
